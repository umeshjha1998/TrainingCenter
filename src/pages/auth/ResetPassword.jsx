                    ...
                    <div className="p-8 sm:p-10">
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div className="text-center mt-4">
                                <Link className="text-sm text-gray-500 dark:text-gray-400 hover:text-[#13ec5b] dark:hover:text-[#13ec5b] transition-colors flex items-center justify-center gap-1 font-display" to="/admin-login">
