...
const CertificateTemplate = forwardRef(({ data }, ref) => {
    ...
    return (
        <div ref={ref} className="print-container relative w-full max-w-[1024px] min-h-[800px] bg-white shadow-2xl rounded-none sm:rounded-sm overflow-hidden flex flex-col mx-auto text-slate-900">
            {/* Background Pattern */}
            ...
            <div className="relative z-20 flex flex-col h-full p-12 sm:p-16 text-center">
                {/* Header */}
                <div className="mb-8">
                    <div className="flex justify-center mb-4">
                        <div className="h-20 w-20 bg-primary/10 rounded-full flex items-center justify-center text-primary border-2 border-primary">
                ...
                <div className="mb-6 flex-grow flex flex-col justify-center">
                    ...
                    {/* Marks Table */}
                    {data.marks && (
                        <div className="w-full max-w-3xl mx-auto bg-white border border-slate-200 rounded-sm overflow-hidden mb-8 shadow-sm text-sm">
